...
export const getTransactionHistory = async (req, res) => {
    try {
        ...
        const formattedTransactions = transactions.map((transaction) => {
            const senderEmail = transaction.sender.user.email === email ? 'me' : transaction.sender.user.email;
            const receiverEmail = transaction.receiver.user.email === email ? 'me' : transaction.receiver.user.email;
